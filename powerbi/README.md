...
- `data/seasons/<season>/derived/driver_metrics.csv`
- `data/seasons/<season>/derived/constructor_metrics.csv`
- `data/seasons/<season>/derived/team_recommendations.csv`

## Import steps (Power BI Desktop on Windows)

1) **Get Data → Text/CSV**
2) Pick each CSV in `data/seasons/<season>/raw/` (available: 2023, 2024, 2025).
3) In Power Query:
